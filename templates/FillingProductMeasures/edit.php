...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $fillingProductMeasure->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $fillingProductMeasure->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="fillingProductMeasures form content">
            ...
            <fieldset>
                <legend><?= __('Edit Filling Product Measure') ?></legend>
                <?php
