    ...
    <?= $this->Form->create($decoration) ?>
                ...
                <div class="box-body">
                    <table>
                        ...
                        <?php if ($this->request->getData()) :
                            ...
                            $decopro=$temp['decoration_products'] ?>
                            <?php foreach ($decopro as $i=>$v) :?>
                            <tr id="tr<?php echo $i;?>">
                                <td><?php echo $i ?>
                                    
                                <td><?php echo $this->Form->control('decoration_products.'.$i.'.product_id', ['options' => $products]);?>
                        ...
                        <?php else : ?>
                            ...
                            <td><?php echo $this->Form->control('decoration_products.0.product_id', ['options' => $products]);?>
                        ...
                        <tr id="trHiddenCounterDetailr" style="display:none;">
                            <input id="tr_d_counterDetailr" type="hidden" value="<?php echo $this->request->getData()?(sizeof($decopro)-1):0;?>">
                        </tr>
            ...
            <div class="box box-solid box-info">
                ...
                <div class="box-body">
                    <table>
                        ...
                        <?php if ($this->request->getData()) :
                            $temp=$this->request->getData();
                            $decodim=$temp['decoration_dimensions'] ?>
                            <?php foreach ($decodim as $i=>$v) :?>
                            <tr id="tr<?php echo $i;?>">
                                <td><?php echo $i ?>
                                    
                                <td><?php echo $this->Form->control('decoration_dimensions.'.$i.'.dimension_id', ['options' => $dimensions]);?>
                        ...
                        <?php else : ?>
                            ...
                            <td><?php echo $this->Form->control('decoration_dimensions.0.dimension_id', ['options' => $dimensions]);?>
                            <td><a style="cursor:pointer;" onclick="$('#tr0').detach();"><span style="background:#aaa;padding:1px 8px;">-</span></a></td>
                            </tr>
                        <?php endif; ?>
                        
                        <tr id="trHiddenCounterDetaild" style="display:none;">
                            <input id="tr_d_counterDetaild" type="hidden" value="<?php echo $this->request->getData()?(sizeof($decodim)-1):0;?>">
                        </tr>
     ...
     <div style="display:none;" id="htmlRaw">
        <xzztr id="trzzz">
            ...
            <xzztd><?php echo $this->Form->control('decoration_products.zzz.product_id', ['options' => $products]);?>
     ...
     <div style="display:none;" id="htmlDetail">
        <xzztr id="trzzz">
            ...
            <xzztd><?php echo $this->Form->control('decoration_dimensions.zzz.dimension_id', ['options' => $dimensions]);?>
            <xzztd><a style="cursor:pointer;" onclick="$('#trzzz').detach();"><span style="background:#aaa;padding:1px 8px;">-</span></a></xzztd>
        </xzztr>
    </div>
