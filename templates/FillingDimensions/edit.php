...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $fillingDimension->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $fillingDimension->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="fillingDimensions form content">
            ...
            <fieldset>
                <legend><?= __('Edit Filling Dimension') ?></legend>
                <?php
